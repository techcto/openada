  ...
  <>
    ...
    <OpenAdaShell current="docs">
      <main className="policy-page">
        ...
        <section><h2>URLs and scan results</h2><p>When you submit a public URL, OpenADA fetches that page and may follow same-host links when you start a site scan. The URL, page metadata, scores, findings, crawl status, and timestamps may be retained to operate the scan and its direct report. The hosted public directory is disabled. Do not submit private, sensitive, authenticated, or personal pages.</p></section>
        ...
        <section><h2>Cookies and accounts</h2><p>The public service does not require an OpenADA account. The service may use standard infrastructure logs and essential browser storage needed to operate the website. OpenADA does not sell submitted scan content.</p></section>
